...
var loadingBannerShownTimestamp = {
    val: -1
}; //wrap in object to pass by ref
const divIdLoadingBanner = "adContainerLoadingLeft";

var mainMenuBannerShownTimestamp = {
    val: -1
}; //wrap in object to pass by ref
const divIdMainMenuBanner = "adContainerMainMenu";

var winCeremonyBannerShownTimestamp = {
    val: -1
}; //wrap in object to pass by ref
const divIdWinCeremonyBanner = "adContainerWin";

var spectateBannerShownTimestamp = {
    val: -1
}; //wrap in object to pass by ref
const divIdSpectateBanner = "adContainerSpectate";

var deathBannerShownTimestamp = {
    val: -1
}; //wrap in object to pass by ref
